...
record IsOrderedField
  ...
  ∣∣-cong : {x y : A} → F x → F y
              ...
              → x ≈ y
              → ∣ x ∣ x' ≈ ∣ y ∣ y'
  ∣∣-cong x' y' (inj₁ x≥0) (inj₁ y≥0) x≈y = x≈y
  ∣∣-cong {x} {y} x' y' (inj₁ x≥0) (inj₂ y≤0) x≈y
            = begin
              x
            ≈˘⟨ x' , proj₂ y≈0∧0≈x ⟩
              0#
  ...
  ∣∣-cong x' y' (inj₂ x≤0) (inj₂ y≤0) x≈y = -‿cong x' y' x≈y
  ...
  lemma-1-1-2-xiii 1≤0 = ⊥-elim false
                        where -1≥0 = ≤-‿reverse 1' 1≤0
                              ...
                              false = 1≉0 1≈0
  1≥0 : 0# ≤ 1#
  1≥0 = [ id , lemma-1-1-2-xiii ] (sign 1')
  ...
  *-sign : {x y : A} → F x → F y
        ...
        → (y ≥ 0# ⊎ y ≤ 0#)
        → ((x * y) ≥ 0# ⊎ (x * y) ≤ 0#)
  *-sign x' y' (inj₁ x≥0) (inj₁ y≥0) = inj₁ (≤*-comp x' y' x≥0 y≥0)
  *-sign x' y' (inj₁ x≥0) (inj₂ y≤0) = inj₂ (prop-1-1-2-xii-3 x' y' x≥0 y≤0)
  *-sign x' y' (inj₂ x≤0) (inj₁ y≥0) = inj₂ (prop-1-1-2-xii-2 x' y' x≤0 y≥0)
  *-sign x' y' (inj₂ x≤0) (inj₂ y≤0) = inj₁ (prop-1-1-2-xii-1 x' y' x≤0 y≤0)
